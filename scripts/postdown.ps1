...
$apiAppId = Get-AzdValue -Name 'API_APP_ID'

# Remove main web app registration
Remove-AppRegistration -ClientId $clientId -AppDisplayName $appDisplayName

# Remove API app registration
Remove-AppRegistration -ClientId $apiAppId -AppDisplayName $apiAppDisplayName

# Clear env values now that apps are gone
Remove-AzdValue -Name 'CLIENT_ID'
Remove-AzdValue -Name 'CLIENT_SECRET'
Remove-AzdValue -Name 'API_APP_ID'
Remove-AzdValue -Name 'API_APP_OBJECT_ID'
Remove-AzdValue -Name 'API_APP_ROLE_ID'
Remove-AzdValue -Name 'API_APP_ID_URI'
