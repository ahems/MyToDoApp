...
resource monitoringMetricsRoleAssignmentForManagedIdentity 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
...
// Apply Monitoring Metrics Publisher Role to the identity
resource monitoringMetricsRoleAssignmentForUser 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(aadAdminObjectId, appInsights.id)
  scope: appInsights
  properties: {
    roleDefinitionId: subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '3913510d-42f4-4e42-8a64-420c390055eb') // Monitoring Metrics Publisher role
